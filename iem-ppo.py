...
if __name__ == '__main__':
    ...
    model = TRPO('MlpPolicy', env, verbose=1, tensorboard_log=log_dir, n_steps=n_steps_per_core, batch_size=n_env, theta=args.theta, sigma=args.sigma, learning_rate=args.learning_rate, n_epochs=args.n_epochs)
