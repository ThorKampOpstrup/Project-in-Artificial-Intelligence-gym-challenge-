...
plot(iterations_vec, sigma_125_avg(:,train_mean_evaluation_reward), 'LineWidth', 1);
plot(iterations_vec, sigma_150_avg(:,train_mean_evaluation_reward), 'LineWidth', 1);
plot(iterations_vec, sigma_175_avg(:,train_mean_evaluation_reward), ':','LineWidth', 1);
plot(iterations_vec, sigma_200_avg(:,train_mean_evaluation_reward), ':','LineWidth', 1);
plot(iterations_vec, sigma_225_avg(:,train_mean_evaluation_reward), ':','LineWidth', 1);
plot(iterations_vec, sigma_250_avg(:,train_mean_evaluation_reward), ':','LineWidth', 1);
plot(iterations_vec, sigma_275_avg(:,train_mean_evaluation_reward), ':', 'LineWidth', 1);
plot(iterations_vec, sigma_300_avg(:,train_mean_evaluation_reward), '--', 'LineWidth', 1);
plot(iterations_vec, sigma_325_avg(:,train_mean_evaluation_reward), '--', 'LineWidth', 1);
plot(iterations_vec, sigma_350_avg(:,train_mean_evaluation_reward), '--', 'LineWidth', 1);
